...
#    3          Added temperature history storage, temp average 
#               algorithm, min and max set points for temp, fixed
#               bugs in updateLights() and in state machine
#------------------------------------------------------------------
...
##
## Set points for minimum and maximum temperature
##
MIN_SETPOINT = 60
MAX_SETPOINT = 85
...
class TemperatureMachine(StateMachine):
    ...
    def processTempIncButton(self):
        ...
        self.setPoint = min(self.setPoint + 1, MAX_SETPOINT)
        self.updateLights()
    ...
    def processTempDecButton(self):
        ...
        self.setPoint = max(self.setPoint - 1, MIN_SETPOINT)
        self.updateLights()
    ...
    def updateLights(self):
        ...
        temp = floor(self.get_average_temp())
    ...
    def get_average_temp(self):
        self.temp_history.append(self.getFahrenheit())
    ...
    def setupSerialOutput(self):
        temp_f = floor(self.get_average_temp())
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                lcd_line_2 = f"Temp: {floor(self.get_average_temp())}F"
